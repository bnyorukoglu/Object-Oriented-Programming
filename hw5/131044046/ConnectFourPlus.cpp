...
namespace bengiSpace {
    ...
    ConnectFourPlus::ConnectFourPlus(const ConnectFourPlus& gelen) {
        width = gelen.width;
        height = gelen.height;
    ...
    ConnectFourPlus& ConnectFourPlus::operator=(const ConnectFourPlus& otherSide) {
