...
//2 oarametreli constractor
ConnectFourAbstract::ConnectFourAbstract(int w, int h) {
    setWidth(w);
    setHeight(h);
    int m;
    gameBoard = new Cell*[getHeight()];
...
//COpy constructor for connectFourAbstrac
ConnectFourAbstract::ConnectFourAbstract(const ConnectFourAbstract &gelen) {
...
ConnectFourAbstract::ConnectFourAbstract(const string& file, char secenek) {
...
//COnnectFOurAbstrac icin aatama operatoru
ConnectFourAbstract& ConnectFourAbstract::operator=(const ConnectFourAbstract &otherSide) {
...
//Board dolu mu onu kontrol eder
//dolu olan kutucuk sayisini dondurur
int ConnectFourAbstract::isItFullBoard() {
...
//girilen dosya icindeki satir sutun doluluguna bakarak satir ve sutun 
//sayisini bulur set eder
void ConnectFourAbstract::satirSutunBul(const string& gelenFile) {
    int sayac = 0;
    int satir = 0;
    int sutun = 0;
    string karakter;
...
//genislik ve yükseklik bu fonksiyonda alinir ve set edilir
const void ConnectFourAbstract::takeWidthAndHeight() {
    int gecici;
...
//girilen sutundaki harfin gecerli olup olmadigi kontrolü yapilir
int ConnectFourAbstract::isValid(char sutun) {
    int sayac = 0;
    char i = 'a';
    int k = 0;
    while (k < getWidth()) {
...
//BU fonksiyonda satir hesaplanir
int ConnectFourAbstract::satirHesapla(char sutun) {
    int satir = 0, i = 0;
    int tut = sutun;
    tut -= 97;
    while (i < getHeight()) {
...
int ConnectFourAbstract::konulanTasinSatiriniHesapla(char sutun) {
    int satir = 0, i = 0;
    int tut = sutun;
    tut -= 97;
...
int ConnectFourAbstract::movPlayerX(char sutun) {
    int tut = sutun;
...
int ConnectFourAbstract::movPlayerO(char sutun) {
    int tut = sutun;
    tut -= 97; //a=0,b=1,c=2...girilen sutunun degerini bulmamızı saglar
    int satir = height - 1;
...
int ConnectFourAbstract::yatayKontrolO(char sutun) {
...
int ConnectFourAbstract::yatayKontrolX(char sutun) {
...
int ConnectFourAbstract::dikeyKontrolX(char sutun) {
...
int ConnectFourAbstract::dikeyKontrolO(char sutun) {
...
int ConnectFourAbstract::caprazKontroller(int satir, char sutun, char oyuncuTasi) {
...
string ConnectFourAbstract::dosyaIsmiBelirleme(string girdi, string komut, bool &dosyaKontrol) {
...
void ConnectFourAbstract::saveFunc(string gelenFile, int flag) {
...
void ConnectFourAbstract::loadFunc(string gelenFile, int &flag) {
...
int ConnectFourAbstract::movPlayerComputer(char sutun, int satir) {
...
void ConnectFourAbstract::play(char sutun) {
